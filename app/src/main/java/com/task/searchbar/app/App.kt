...
import com.task.searchbar.data.di.DaggerDataComponent
        ...
        DaggerAppComponent.builder()
            .presentationComponent(
                DaggerPresentationComponent.builder().domainComponent(
                    DaggerDomainComponent.builder().bindsDataComponent(
                        DaggerDataComponent.builder().appContext(this).build()
                    ).bindsContext(this).build()
                ).build()
            ).build()
            .inject(this)
    }
